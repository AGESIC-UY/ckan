...
package_table = Table('package', meta.metadata,
        ...
        Column('author', types.UnicodeText, nullable=False),
        Column('author_email', types.UnicodeText, nullable=False),
        Column('maintainer', types.UnicodeText, nullable=False),
        Column('maintainer_email', types.UnicodeText, nullable=False),
        Column('notes', types.UnicodeText, nullable=False),
